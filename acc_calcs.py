...
plt.subplot(4,3,1)
plt.plot(timep[camRnge[0]:camRnge[1]],camX1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,4)
plt.plot(timev[camRnge[0]:camRnge[1]],camVelX1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,7)
plt.plot(timea[camRnge[0]:camRnge[1]],camAccX1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,10)
plt.plot(timej[camRnge[0]:camRnge[1]],camJerkX1[camRnge[0]:camRnge[1]])

plt.subplot(4,3,2)
plt.plot(timep[camRnge[0]:camRnge[1]],camY1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,5)
plt.plot(timev[camRnge[0]:camRnge[1]],camVelY1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,8)
plt.plot(timea[camRnge[0]:camRnge[1]],camAccY1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,11)
plt.plot(timej[camRnge[0]:camRnge[1]],camJerkY1[camRnge[0]:camRnge[1]])

plt.subplot(4,3,3)
plt.plot(timep[camRnge[0]:camRnge[1]],camZ1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,6)
plt.plot(timev[camRnge[0]:camRnge[1]],camVelZ1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,9)
plt.plot(timea[camRnge[0]:camRnge[1]],camAccZ1[camRnge[0]:camRnge[1]])
plt.subplot(4,3,12)
plt.plot(timej[camRnge[0]:camRnge[1]],camJerkZ1[camRnge[0]:camRnge[1]])
#plt.subplot(3,3,5)
